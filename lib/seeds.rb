...
students_1 = 
["Amanda Steckler", "Benjamin Henriquez", "Caleb Cox", "Charlie Spencer", "Chris Peleti", "Colby Pines", "Craig Iturbe", "Drew Nickerson", "Eoghan Leddy", "Jake Zappin"]
web = Course.new(name: "web", students: students_1)

group1 = Group.new(group_size: 3, course: web)
# y = web.student_objects[0].student_group_history.flatten!.reject{|z|"Amanda Steckler"}
group2 = Group.new(group_size: 2, course: web)
